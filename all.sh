...
./build/UnscentedKF $@    ./data/sample-laser-radar-measurement-data-1.txt ./output/data1_all.txt
...
./build/UnscentedKF $@    ./data/sample-laser-radar-measurement-data-2.txt ./output/data2_all.txt
